...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        public static bool DragFloat4(string label, ref Vector4 v)
        {
            ...
            float v_min = 0.0f;
            float v_max = 0.0f;
            int format_byteCount = ("%.3f" != null) ? Encoding.UTF8.GetByteCount("%.3f") : 0;
            byte* native_format = stackalloc byte[format_byteCount + 1];
            fixed (char* format_ptr = "%.3f")
            {
                int native_format_offset = ("%.3f" != null) ? Encoding.UTF8.GetBytes(format_ptr, "%.3f".Length, native_format, format_byteCount) : 0;
                native_format[native_format_offset] = 0;
            }
            native_format = ("%.3f" != null) ? native_format : null;
            float power = 1.0f;
        ...
        {
            int version_str_byteCount = (version_str != null) ? Encoding.UTF8.GetByteCount(version_str) : 0;
            byte* native_version_str = stackalloc byte[version_str_byteCount + 1];
            fixed (char* version_str_ptr = version_str)
            {
                int native_version_str_offset = (version_str != null) ? Encoding.UTF8.GetBytes(version_str_ptr, version_str.Length, native_version_str, version_str_byteCount) : 0;
                native_version_str[native_version_str_offset] = 0;
            }
            native_version_str = (version_str != null) ? native_version_str : null;
        ...
        {
            int prefix_byteCount = (prefix != null) ? Encoding.UTF8.GetByteCount(prefix) : 0;
            byte* native_prefix = stackalloc byte[prefix_byteCount + 1];
            fixed (char* prefix_ptr = prefix)
            {
                int native_prefix_offset = (prefix != null) ? Encoding.UTF8.GetBytes(prefix_ptr, prefix.Length, native_prefix, prefix_byteCount) : 0;
                native_prefix[native_prefix_offset] = 0;
            }
            native_prefix = (prefix != null) ? native_prefix : null;
        ...
        public static void Value(string prefix, float v, string float_format)
        {
            ...
            native_prefix = (prefix != null) ? native_prefix : null;
            int float_format_byteCount = (float_format != null) ? Encoding.UTF8.GetByteCount(float_format) : 0;
            byte* native_float_format = stackalloc byte[float_format_byteCount + 1];
            fixed (char* float_format_ptr = float_format)
            {
                int native_float_format_offset = (float_format != null) ? Encoding.UTF8.GetBytes(float_format_ptr, float_format.Length, native_float_format, float_format_byteCount) : 0;
                native_float_format[native_float_format_offset] = 0;
            }
            native_float_format = (float_format != null) ? native_float_format : null;
            ImGuiNative.igValueFloat(native_prefix, v, native_float_format);
        }
        ...
        public static bool DragIntRange2(string label, ref int v_current_min, ref int v_current_max)
        {
            ...
            int v_min = 0;
            int v_max = 0;
            int format_byteCount = ("%d" != null) ? Encoding.UTF8.GetByteCount("%d") : 0;
            byte* native_format = stackalloc byte[format_byteCount + 1];
            fixed (char* format_ptr = "%d")
            {
                int native_format_offset = ("%d" != null) ? Encoding.UTF8.GetBytes(format_ptr, "%d".Length, native_format, format_byteCount) : 0;
                native_format[native_format_offset] = 0;
            }
            native_format = ("%d" != null) ? native_format : null;
        ...
        public static bool DragIntRange2(string label, ref int v_current_min, ref int v_current_max, float v_speed, int v_min, int v_max, string format, string format_max)
        {
            ...
            native_format = (format != null) ? native_format : null;
            int format_max_byteCount = (format_max != null) ? Encoding.UTF8.GetByteCount(format_max) : 0;
            byte* native_format_max = stackalloc byte[format_max_byteCount + 1];
            fixed (char* format_max_ptr = format_max)
            {
                int native_format_max_offset = (format_max != null) ? Encoding.UTF8.GetBytes(format_max_ptr, format_max.Length, native_format_max, format_max_byteCount) : 0;
                native_format_max[native_format_max_offset] = 0;
            }
            native_format_max = (format_max != null) ? native_format_max : null;
            fixed (int* native_v_current_min = &v_current_min)
            {
                fixed (int* native_v_current_max = &v_current_max)
                {
        ...
        {
            int ini_filename_byteCount = (ini_filename != null) ? Encoding.UTF8.GetByteCount(ini_filename) : 0;
            byte* native_ini_filename = stackalloc byte[ini_filename_byteCount + 1];
            fixed (char* ini_filename_ptr = ini_filename)
            {
                int native_ini_filename_offset = (ini_filename != null) ? Encoding.UTF8.GetBytes(ini_filename_ptr, ini_filename.Length, native_ini_filename, ini_filename_byteCount) : 0;
                native_ini_filename[native_ini_filename_offset] = 0;
            }
            native_ini_filename = (ini_filename != null) ? native_ini_filename : null;
        ...
        public static bool InputInt4(string label, int[] v)
        {
            ...
            if (v.Length != 4)
            {
                throw new ArgumentException("Array size mismatch", "v.length = " + v.Length + ", 4 expected");
            }
            int* native_v = stackalloc int[4];
            for (int i = 0; i < 4; i++)
            {
                native_v[i] = v[i];
            }
        ...
        public static void LabelText(string label, string fmt)
        {
            ...
            native_label = (label != null) ? native_label : null;
            int fmt_byteCount = (fmt != null) ? Encoding.UTF8.GetByteCount(fmt) : 0;
            byte* native_fmt = stackalloc byte[fmt_byteCount + 1];
            fixed (char* fmt_ptr = fmt)
            {
                int native_fmt_offset = (fmt != null) ? Encoding.UTF8.GetBytes(fmt_ptr, fmt.Length, native_fmt, fmt_byteCount) : 0;
                native_fmt[native_fmt_offset] = 0;
            }
            native_fmt = (fmt != null) ? native_fmt : null;
        ...
        {
            int str_id_byteCount = (str_id != null) ? Encoding.UTF8.GetByteCount(str_id) : 0;
            byte* native_str_id = stackalloc byte[str_id_byteCount + 1];
            fixed (char* str_id_ptr = str_id)
            {
                int native_str_id_offset = (str_id != null) ? Encoding.UTF8.GetBytes(str_id_ptr, str_id.Length, native_str_id, str_id_byteCount) : 0;
                native_str_id[native_str_id_offset] = 0;
            }
            native_str_id = (str_id != null) ? native_str_id : null;
            int mouse_button = 1;
            byte ret = ImGuiNative.igOpenPopupOnItemClick(native_str_id, mouse_button);
            return ret != 0;
        }
        ...
        {
            int ini_data_byteCount = (ini_data != null) ? Encoding.UTF8.GetByteCount(ini_data) : 0;
            byte* native_ini_data = stackalloc byte[ini_data_byteCount + 1];
            fixed (char* ini_data_ptr = ini_data)
            {
                int native_ini_data_offset = (ini_data != null) ? Encoding.UTF8.GetBytes(ini_data_ptr, ini_data.Length, native_ini_data, ini_data_byteCount) : 0;
                native_ini_data[native_ini_data_offset] = 0;
            }
            native_ini_data = (ini_data != null) ? native_ini_data : null;
            uint ini_size = 0;
        ...
        public static bool SliderInt2(string label, int[] v, int v_min, int v_max)
        {
            ...
            if (v.Length != 2)
            {
                throw new ArgumentException("Array size mismatch", "v.length = " + v.Length + ", 2 expected");
            }
            int* native_v = stackalloc int[2];
            for (int i = 0; i < 2; i++)
            {
                native_v[i] = v[i];
            }
        ...
        {
            int name_byteCount = (name != null) ? Encoding.UTF8.GetByteCount(name) : 0;
            byte* native_name = stackalloc byte[name_byteCount + 1];
            fixed (char* name_ptr = name)
            {
                int native_name_offset = (name != null) ? Encoding.UTF8.GetBytes(name_ptr, name.Length, native_name, name_byteCount) : 0;
                native_name[native_name_offset] = 0;
            }
            native_name = (name != null) ? native_name : null;
            ImGuiCond cond = 0;
        ...
        public static bool MenuItem(string label, string shortcut)
        {
            ...
            native_label = (label != null) ? native_label : null;
            int shortcut_byteCount = (shortcut != null) ? Encoding.UTF8.GetByteCount(shortcut) : 0;
            byte* native_shortcut = stackalloc byte[shortcut_byteCount + 1];
            fixed (char* shortcut_ptr = shortcut)
            {
                int native_shortcut_offset = (shortcut != null) ? Encoding.UTF8.GetBytes(shortcut_ptr, shortcut.Length, native_shortcut, shortcut_byteCount) : 0;
                native_shortcut[native_shortcut_offset] = 0;
            }
            native_shortcut = (shortcut != null) ? native_shortcut : null;
            byte selected = 0;
            byte enabled = 1;
            byte ret = ImGuiNative.igMenuItemBool(native_label, native_shortcut, selected, enabled);
            return ret != 0;
        ...
        {
            int overlay_byteCount = (overlay != null) ? Encoding.UTF8.GetByteCount(overlay) : 0;
            byte* native_overlay = stackalloc byte[overlay_byteCount + 1];
            fixed (char* overlay_ptr = overlay)
            {
                int native_overlay_offset = (overlay != null) ? Encoding.UTF8.GetBytes(overlay_ptr, overlay.Length, native_overlay, overlay_byteCount) : 0;
                native_overlay[native_overlay_offset] = 0;
            }
            native_overlay = (overlay != null) ? native_overlay : null;
            ImGuiNative.igProgressBar(fraction, size_arg, native_overlay);
        }
        ...
        {
            int desc_id_byteCount = (desc_id != null) ? Encoding.UTF8.GetByteCount(desc_id) : 0;
            byte* native_desc_id = stackalloc byte[desc_id_byteCount + 1];
            fixed (char* desc_id_ptr = desc_id)
            {
                int native_desc_id_offset = (desc_id != null) ? Encoding.UTF8.GetBytes(desc_id_ptr, desc_id.Length, native_desc_id, desc_id_byteCount) : 0;
                native_desc_id[native_desc_id_offset] = 0;
            }
            native_desc_id = (desc_id != null) ? native_desc_id : null;
        ...
        public static bool InputDouble(string label, ref double v)
        {
            ...
            int format_byteCount = ("%.6f" != null) ? Encoding.UTF8.GetByteCount("%.6f") : 0;
            byte* native_format = stackalloc byte[format_byteCount + 1];
            fixed (char* format_ptr = "%.6f")
            {
                int native_format_offset = ("%.6f" != null) ? Encoding.UTF8.GetBytes(format_ptr, "%.6f".Length, native_format, format_byteCount) : 0;
                native_format[native_format_offset] = 0;
            }
            native_format = ("%.6f" != null) ? native_format : null;
            ImGuiInputTextFlags extra_flags = 0;
        ...
        public static bool BeginCombo(string label, string preview_value)
        {
            ...
            native_label = (label != null) ? native_label : null;
            int preview_value_byteCount = (preview_value != null) ? Encoding.UTF8.GetByteCount(preview_value) : 0;
            byte* native_preview_value = stackalloc byte[preview_value_byteCount + 1];
            fixed (char* preview_value_ptr = preview_value)
            {
                int native_preview_value_offset = (preview_value != null) ? Encoding.UTF8.GetBytes(preview_value_ptr, preview_value.Length, native_preview_value, preview_value_byteCount) : 0;
                native_preview_value[native_preview_value_offset] = 0;
            }
            native_preview_value = (preview_value != null) ? native_preview_value : null;
        ...
        public static bool InputInt3(string label, int[] v)
        {
            ...
            if (v.Length != 3)
            {
                throw new ArgumentException("Array size mismatch", "v.length = " + v.Length + ", 3 expected");
            }
            int* native_v = stackalloc int[3];
            for (int i = 0; i < 3; i++)
            {
                native_v[i] = v[i];
            }
        ...
        {
            int id_byteCount = (id != null) ? Encoding.UTF8.GetByteCount(id) : 0;
            byte* native_id = stackalloc byte[id_byteCount + 1];
            fixed (char* id_ptr = id)
            {
                int native_id_offset = (id != null) ? Encoding.UTF8.GetBytes(id_ptr, id.Length, native_id, id_byteCount) : 0;
                native_id[native_id_offset] = 0;
            }
            native_id = (id != null) ? native_id : null;
            byte border = 1;
            ImGuiNative.igColumns(count, native_id, border);
        }
        ...
        public static bool BuildFontAtlas(ImFontAtlasPtr atlas)
        {
            ImFontAtlas* native_atlas = atlas.NativePtr;
            ImRasterizerFlags extra_flags = 0;
            byte ret = ImGuiNative.igBuildFontAtlas(native_atlas, extra_flags);
            return ret != 0;
        }
        public static bool BuildFontAtlas(ImFontAtlasPtr atlas, ImRasterizerFlags extra_flags)
        {
            ImFontAtlas* native_atlas = atlas.NativePtr;
            byte ret = ImGuiNative.igBuildFontAtlas(native_atlas, extra_flags);
            return ret != 0;
