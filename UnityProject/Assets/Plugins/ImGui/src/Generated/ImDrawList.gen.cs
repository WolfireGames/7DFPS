...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImDrawListPtr
    {
        ...
        public ImVector_ImDrawVert VtxBuffer => new ImVector_ImDrawVert(NativePtr->VtxBuffer);
        public ImDrawListFlags Flags { get { return (ImDrawListFlags)NativePtr->Flags; } set { NativePtr->Flags = value; } }
        public IntPtr _Data { get { return (IntPtr)NativePtr->_Data; } set { NativePtr->_Data = value; } }
        public NullTerminatedString _OwnerName => new NullTerminatedString(NativePtr->_OwnerName);
        public uint _VtxCurrentIdx { get { return (uint)NativePtr->_VtxCurrentIdx; } set { NativePtr->_VtxCurrentIdx = value; } }
        ...
        public int _ChannelsCurrent { get { return (int)NativePtr->_ChannelsCurrent; } set { NativePtr->_ChannelsCurrent = value; } }
        public int _ChannelsCount { get { return (int)NativePtr->_ChannelsCount; } set { NativePtr->_ChannelsCount = value; } }
        public ImVector<ImDrawChannel> _Channels => new ImVector<ImDrawChannel>(NativePtr->_Channels);
