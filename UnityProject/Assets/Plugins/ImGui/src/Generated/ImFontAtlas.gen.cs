...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImFontAtlasPtr
    {
        ...
        public Bool8 Locked { get { return new Bool8(NativePtr->Locked); } set { NativePtr->Locked = (byte)(value ? 1 : 0); } }
        public ImFontAtlasFlags Flags { get { return (ImFontAtlasFlags)NativePtr->Flags; } set { NativePtr->Flags = value; } }
        public IntPtr TexID { get { return (IntPtr)NativePtr->TexID; } set { NativePtr->TexID = value; } }
        public int TexDesiredWidth { get { return (int)NativePtr->TexDesiredWidth; } set { NativePtr->TexDesiredWidth = value; } }
        public int TexGlyphPadding { get { return (int)NativePtr->TexGlyphPadding; } set { NativePtr->TexGlyphPadding = value; } }
        ...
        public int TexWidth { get { return (int)NativePtr->TexWidth; } set { NativePtr->TexWidth = value; } }
        public int TexHeight { get { return (int)NativePtr->TexHeight; } set { NativePtr->TexHeight = value; } }
        public Vector2 TexUvScale { get { return (Vector2)NativePtr->TexUvScale; } set { NativePtr->TexUvScale = value; } }
        public Vector2 TexUvWhitePixel { get { return (Vector2)NativePtr->TexUvWhitePixel; } set { NativePtr->TexUvWhitePixel = value; } }
        public ImPtrVector<ImFont> Fonts => new ImPtrVector<ImFont>(NativePtr->Fonts, UnsafeUtility.SizeOf<ImFont>());
        public ImVector<CustomRect> CustomRects => new ImVector<CustomRect>(NativePtr->CustomRects);
        public ImVector<ImFontConfig> ConfigData => new ImVector<ImFontConfig>(NativePtr->ConfigData);
        ...
        public ImFontPtr AddFontFromMemoryCompressedBase85TTF(string compressed_font_data_base85, float size_pixels, ImFontConfig font_cfg)
        {
            int compressed_font_data_base85_byteCount = (compressed_font_data_base85 != null) ? Encoding.UTF8.GetByteCount(compressed_font_data_base85) : 0;
            byte* native_compressed_font_data_base85 = stackalloc byte[compressed_font_data_base85_byteCount + 1];
            fixed (char* compressed_font_data_base85_ptr = compressed_font_data_base85)
        ...
        public ImFontPtr AddFont(ImFontConfig font_cfg)
        {
            ImFontConfigNative* native_font_cfg = font_cfg.NativePtr;
        ...
        public ImFontPtr AddFontFromFileTTF(string filename, float size_pixels, ImFontConfig font_cfg, ref ushort glyph_ranges)
        {
            int filename_byteCount = (filename != null) ? Encoding.UTF8.GetByteCount(filename) : 0;
            byte* native_filename = stackalloc byte[filename_byteCount + 1];
            fixed (char* filename_ptr = filename)
