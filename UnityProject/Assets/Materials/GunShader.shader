...
////// Specular:
                ...
                float3 diffuseColor = (i.vertexColor.rgb+Object_TPM( _Texture , i.posWorld.rgb , objPos.rgb , i.normalDir , _Detail_var , _Scale_var )); // Need this for specular when using metallic
