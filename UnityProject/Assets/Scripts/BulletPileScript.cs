...
public class BulletPileScript : MonoBehaviour {
    public void Start() {
        ...
        if (Random.Range(0, 4) == 0 && weapon_holder.mag_object != null && PlayerPrefs.GetInt("modifier_spawn_magazines") == 1) {
            if (weapon_holder.mag_object.TryGetComponent(out mag_script magazinePrefab)) {
                ...
                magazine.transform.position = transform.position + new Vector3(Random.Range(-0.1f, 0.1f), Random.Range(0.2f, 0.4f), Random.Range(-0.1f, 0.1f));
        ...
        for (int i = 0; i < num_bullets; ++i) {
            ...
            bullet.transform.position = transform.position + new Vector3(Random.Range(-0.1f, 0.1f), Random.Range(0.0f, 0.2f), Random.Range(-0.1f, 0.1f));
        ...
        if (Random.Range(0, 4) == 0) {
            ...
            tape.transform.position = transform.position + new Vector3(Random.Range(-0.1f, 0.1f), Random.Range(0.0f, 0.2f), Random.Range(-0.1f, 0.1f));
        ...
        if (Random.Range(0, 4) == 0 && !holder.has_flashlight) {
            ...
            flashlight.transform.position = transform.position + new Vector3(Random.Range(-0.1f, 0.1f), Random.Range(0.2f, 0.4f), Random.Range(-0.1f, 0.1f));
